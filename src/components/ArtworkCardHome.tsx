...
const ArtworkCardHome: React.FC<ArtworkCardHomeProps> = ({ 
  ...
  return (
    <Card 
      className="group cursor-pointer overflow-hidden bg-white dark:bg-mirakiBlue-800 border border-mirakiGray-200 dark:border-mirakiBlue-700 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 h-full"
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {imageError ? (
          ...
          <img
            src={imageUrl}
            alt={artwork.title}
            className={`relative z-10 w-full h-full object-cover transform group-hover:scale-105 transition-all duration-500 ${
